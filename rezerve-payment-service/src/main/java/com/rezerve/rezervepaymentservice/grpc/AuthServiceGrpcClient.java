...
import com.rezerve.rezervepaymentservice.exception.UserNotFoundException;
...
public class AuthServiceGrpcClient {
    ...
    public AuthServiceGrpcClient(@Value("${auth.service.address:localhost}") String serverAddress, @Value("${auth.service.grpc.port:9001}") int serverPort, PaymentMapper paymentMapper) {
    ...
    public AuthServiceGrpcResponseDto extractUserInfo(String token){
        ...
        try{
            ...
            return paymentMapper.toAuthServiceGrpcResponseDto(authResponse);
